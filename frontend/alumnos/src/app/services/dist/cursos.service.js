...
var sdk_service_1 = require("./sdk.service");
var CursosService = /** @class */ (function (_super) {
    __extends(CursosService, _super);
    function CursosService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CursosService.prototype.getCursos = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.get(this.endpoints.cursos.link, data)];
            });
        });
    };
